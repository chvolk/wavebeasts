...
gd.ellipse([W - 620, -260, W + 260, 360], fill=(34, 10, 9))
img = Image.blend(img, glow, 0.6)
d = ImageDraw.Draw(img)

# silver hairline frame
d.rectangle([24, 24, W - 24, H - 24], outline=(58, 60, 68), width=2)
...
d.text((70, 210), "WAVEBEASTS", font=font(96), fill=SILVER_HI)
# red underline
d.line([74, 320, 74 + 700, 320], fill=RED, width=4)
...
# beast (right), red on the glow, yellow accent
cx, cy = 960, 300
d.polygon([(cx - 90, cy - 70), (cx - 55, cy - 150), (cx - 15, cy - 78)], fill=RED)
d.polygon([(cx + 90, cy - 70), (cx + 55, cy - 150), (cx + 15, cy - 78)], fill=RED)
d.ellipse([cx - 120, cy - 60, cx + 120, cy + 150], fill=RED)
d.ellipse([cx - 78, cy - 10, cx + 78, cy + 130], fill=RED_HI)
...
d.polygon([(cx - 14, cy + 60), (cx, cy + 92), (cx + 14, cy + 60)], fill=YELLOW)
